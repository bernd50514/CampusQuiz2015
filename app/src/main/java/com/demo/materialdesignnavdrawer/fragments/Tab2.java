...
public class Tab2 extends ListFragment {
    ...
    private static final String TAG_MESSAGES = "RangUni";
    private static final String TAG_RANG = "rang";
    private static final String TAG_UNI = "uni";
    ProgressDialog pDialog;
    String INDIVIDUAL_URL = "http://ps15server.cloudapp.net:8080/useraccount/InfoService/getRangUni";
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                for (int i = 0; i < inbox.length(); i++) {
                    ...
                    String uni = c.getString(TAG_UNI);
            ...
            getActivity().runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            ...
                            R.layout.tab2_list, new String[]{TAG_UNI, TAG_RANG},
                            new int[]{R.id.user_uni_tab2, R.id.user_ranking_tab2});
                    // updating listview
